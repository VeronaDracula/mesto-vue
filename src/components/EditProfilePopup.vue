...
<template>
    <section class="popup" :class="{ opened: popupsStore.isPopupEditProfileOpen }">
        <div class="popup__container">
            <button class="popup__close page__button" @click="popupsStore.closePopupEditProfile()"></button>
